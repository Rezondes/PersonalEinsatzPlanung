...
const schedule = {
  ...
  warningSummary_one: '{{count}} Warnung',
  warningSummary_other: '{{count}} Warnungen',
  weekShort: 'KW {{week}}',
  weekLoadingAriaLabel: 'Woche wird geladen',
  ...
  errorHintAriaLabel: 'Fehler anzeigen',
  warningHintAriaLabel: 'Warnung anzeigen',
  ...
  removeBreakAriaLabel: 'Pause {{breakNumber}} entfernen (Schicht {{number}})',
