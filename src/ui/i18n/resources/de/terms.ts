/** TermsView-specific copy. The page heading itself reuses nav.terms (identical text). `sections`
 * is read back via t('sections', { returnObjects: true }) - see privacy.ts for the same pattern. */
const terms = {
  sections: [
    {
